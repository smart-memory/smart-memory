...
class TestGetEventSink:
    def setup_method(self):
        ...
        import smartmemory_cc.event_sink as _mod
        _mod._sink = None
...
class TestStartBackground:
    ...
    def test_sequential_idempotent(self):
        ...
        with patch("smartmemory_cc.events_server._serve", side_effect=_fake_serve):
...
class TestServe:
    def test_oserror_logs_warning_does_not_raise(self):
        ...
        with (
            patch("smartmemory_cc.events_server.log") as mock_log,
            patch("smartmemory_cc.event_sink.get_event_sink", return_value=mock_sink),
    ...
    def test_attach_loop_none_called_in_finally(self):
        ...
        with (
            ...
            patch("smartmemory_cc.events_server.log"),
        ):
            asyncio.run(_mod._serve(port=19999))
