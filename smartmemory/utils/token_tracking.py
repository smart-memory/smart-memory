...
class TokenTracker:
    ...
    def track(
        ...
        usage = TokenUsage(
            prompt_tokens=prompt_tokens, completion_tokens=completion_tokens, total_tokens=total_tokens, model=model
        )
...
def track_usage(
    response: Any = None, prompt_tokens: int = 0, completion_tokens: int = 0, total_tokens: int = 0, model: str = ""
):
