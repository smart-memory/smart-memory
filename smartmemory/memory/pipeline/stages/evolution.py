...
class EvolutionOrchestrator:
    ...
    def run_workflow(self, context: Optional[Dict[str, Any]] = None, stop_on_error: bool = False) -> Dict[str, Any]:
        ...
        for node_id in order:
            ...
            try:
                ...
                logger.info(
                    f"Workflow node '{node_id}' executed: {type(evolver).__name__} -> {type(result).__name__ if result is not None else 'None'}"
                )
    ...
    def commit_working_to_episodic(self, remove_from_source: bool = True) -> List[str]:
        ...
        try:
            ...
            logger.warning(f"WorkingToEpisodicEvolver not available or API mismatch: {e}")
    ...
    def commit_working_to_procedural(self, remove_from_source: bool = True) -> List[str]:
        ...
        try:
            ...
            logger.warning(f"WorkingToProceduralEvolver not available or API mismatch: {e}")
